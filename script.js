...
var TodoBox = React.createClass({
	...
	getInitialState: function getInitialState() {
		return {
			data: [{ "id": "00001", "task": "Справа №1(ще не придумав)", "complete": "false" }]
		};
	},
				...
				React.createElement(
					...
					React.createElement(
						...
						React.createElement(
							"div",
							{ className: "col-md-10" },
							React.createElement("input", { type: "text", id: "task", ref: "task", className: "form-control" })
						)
					),
					React.createElement(
						"div",
						...
						React.createElement(
							...
							React.createElement("input", { type: "submit", value: "Додати", className: "btn btn-primary" })
						)
					)
				)
			)
